    ...
    <el-form ref="form" :model="form" :rules="formRules" label-width="150px">
      <div v-for="(item, row) in formList" :key="row">
        <div class="form-row">
          ...
          <!-- 销售属性 -->
          <el-form-item
            v-else-if="item.type === 'inline-select2'"
            :label="item.label"
            :prop="item.prop"
          >
            <el-form
              ref="skuSaleAttrValueList"
              :inline="true"
              label-width="120px"
            >
              <div class="form-row form-row-warp">
                <div
                  v-for="(skuSale, inlineRow) in skuSaleAttrValueList"
                  :key="inlineRow"
                >
          ...
          <!-- 平台属性 -->
          <el-form-item
            v-else-if="item.type === 'inline-select1'"
            :label="item.label"
            :prop="item.prop"
          >
            <el-form ref="skuAttrValueList" :inline="true" label-width="120px">
              <div class="form-row form-row-warp">
                <div
                  v-for="(skuAttr, inlineRow) in skuAttrValueList"
                  :key="inlineRow"
                >
